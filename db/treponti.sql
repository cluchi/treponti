...
-- Dumping data for table treponti.adminnotification_inbox: ~66 rows (approximately)
...
-- Dumping data for table treponti.cms_page: ~7 rows (approximately)
...
-- Dumping data for table treponti.directory_country_region: ~603 rows (approximately)
...
-- Dumping data for table treponti.directory_country_region_name: ~381 rows (approximately)
